...
const translations = {
	zh: {
		...
		"wordList.englishColumn": "英文列",
		"wordList.chineseColumn": "中文列",
		"wordList.toggleEnglish": "点击切换显示/隐藏英文",
		"wordList.toggleChinese": "点击切换显示/隐藏中文",
		"wordList.clickToShow": "点击显示",
		"wordList.title": "📖 {deckName} 单词列表",
		"wordList.subtitle": "共 {count} 个单词 · 标签 {tag}",
		"wordList.restoreOrder": "恢复顺序",
		"wordList.shuffle": "乱序",
		"wordList.unmaskEnglish": "取消遮罩英文",
		"wordList.maskEnglish": "遮罩英文",
		"wordList.unmaskChinese": "取消遮罩中文",
		"wordList.maskChinese": "遮罩中文",
		"stats.title": "学习统计",
	...
	en: {
		...
		"wordList.englishColumn": "English column",
		"wordList.chineseColumn": "Chinese column",
		"wordList.toggleEnglish": "Click to show/hide English",
		"wordList.toggleChinese": "Click to show/hide Chinese",
		...
		"wordList.unmaskEnglish": "Show English",
		"wordList.maskEnglish": "Mask English",
		"wordList.unmaskChinese": "Show Chinese",
		"wordList.maskChinese": "Mask Chinese",
