...
import { createFlashcardFeature } from "../features/flashcards";
...
vi.mock("../../sessions/sessionLifecycle", () => ({
...
vi.mock("../../identity/cardIdentityContinuity", () => ({
...
vi.mock("../../identity/cardIdentity", () => ({ createCardIdentity: vi.fn() }));

vi.mock("../cardIdentityContinuityAdapters", () => ({
	createObsidianContinuitySourceStore: vi.fn(),
}));

vi.mock("../cardIdentityContinuityModals", () => ({
