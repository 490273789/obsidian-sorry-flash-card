...
import { inspectCompiledPackage, type CompiledPackageStatus } from "../dictionary/compiled-package";
import {
...
import type { LocalDictionaryAdministrationFailureCode } from "../dictionary/local-administration";
import type {
	DictionarySettings,
	PersistedYoudaoDictionarySettings,
	YoudaoDictionarySettings,
} from "../dictionary/types";
import { YoudaoDictionarySource } from "../dictionary/youdao";
import { dictionaryStrings, type DictionaryStrings } from "../i18n/dictionary";
import type { Language } from "../shared/types";
import {
	buildDictionarySettingsViewModel,
	formatDictionaryBytes,
	type DictionarySettingsEditorActions,
} from "../settings/dictionarySettingsViewModel";
import type { SettingsViewModelDefinition } from "../settings/settingsViewModel";
import { confirmLocalDictionaryDeletion } from "./dictionaryModals";
