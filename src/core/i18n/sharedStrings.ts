...
export const sharedTranslations = {
	zh: {
		...
		"workbench.title": "学习工作台",
		"workbench.subtitle": "选择一个功能开始，各功能仍可在独立标签页中并排使用。",
		"workbench.unavailable": "已停用",
		"workbench.openSettings": "打开设置",
		"common.cancel": "取消",
		"common.all": "全部",
		"common.cards": "张卡片",
		"common.questions": "题",
	...
	en: {
		...
		"workbench.title": "Study workbench",
		"workbench.subtitle":
			"Pick a feature to start. Each one still opens in its own tab, so they can sit side by side.",
		"workbench.unavailable": "Disabled",
